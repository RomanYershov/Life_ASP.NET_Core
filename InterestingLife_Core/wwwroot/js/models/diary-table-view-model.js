define(['ko', 'jquery'], function (ko, $) {
    return function (params) {
        ...
        ko.components.register('table-block',
            {
                viewModel: { require: 'models/table-model' },
                template: { require: 'text!/js/view/table-view-model.html' }
            });

        ko.components.register('description-list-block', {
            viewModel: { require: 'models/description-list-view-model' },
            template: { require: 'text!/js/view/description-list-view-model.html' }
        });

        ko.components.register('description-text-block',
            {
